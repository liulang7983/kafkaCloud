...
public class EmployeesServiceImpl implements EmployeesService {
    ...
    public int create(Employees employees) {
        ...
        if (1>0){
            ...
            bloomFilter.contains("employees:" + employees.getName());
            bloomFilter.add("employees:"+employees.getName());
    ...
    public Employees getByName(String name) {
        ...
        if (bloomFilter.contains("employees:"+name)){
    ...
    public Employees read(String name) {
        ...
        RReadWriteLock lock = redissonClient.getReadWriteLock(employeesLock);
